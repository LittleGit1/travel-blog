@include('partials.head', ['title' => "Edit $country->name"])
...
<main class="container mx-auto">
    <form x-data="countries" @submit.prevent="prepareForm" action="/account/journey/countries/create" method="POST">
        ...
        <div>
            <h1 class="text-3xl font-medium">Edit country</h1>
        </div>
        ...
        <div class="flex gap-2">
            <x-button type="submit" backgroundColor="bg-green-600">Update</x-button>
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('countries', () => ({
            ...
            newCities: JSON.parse(@json($cities)),
            ...
            addNewCity() {
                ...
                this.newCities.push({
                    ...
                    lat: parseFloat(this.newCityLatitude),
                    lng: parseFloat(this.newCityLongitude)
                })
